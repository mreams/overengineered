...
public class GreetingControllerTests {
    ...
    public void paramGreetingShouldReturnCorrectLanguage() throws Exception {
        ...
        this.mockMvc.perform(get("/greeting").param("language", "es"))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(jsonPath("$.content").value("Hola, World!"));
    }

    @Test
    public void paramGreetingShouldReturnDefaultForUnknownLanguage() throws Exception {

        this.mockMvc.perform(get("/greeting").param("language", "xx"))
                .andDo(print()).andExpect(status().isOk())
                .andExpect(jsonPath("$.content").value("Hello, World!"));
    }
    ...
    public void paramGreetingShouldFailOnBadLanguage() throws Exception {
        ...
        this.mockMvc.perform(get("/greeting").param("language", "zzzzzzzzzz"))
                .andDo(print())
